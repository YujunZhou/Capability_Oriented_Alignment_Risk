...
# Parse CLI: -m model
# -m some_model => your-org/Advanced_Risk_Situation_Aware_some_model
# --sft => your-org/SFT_Advanced_Risk_Situation_Aware_some_model
TASK_NAME="Situation_Aware"
...
TRAIN_PATH=${DATA_DIR}/train_no_sorry.parquet
VAL_PATH=${DATA_DIR}/test_no_sorry.parquet
...
set_project_and_experiment_prefix "Secure_Situation_Aware"
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=./verl/utils/reward_score/llm_judge_secure.py \
